...
<title>RentaBike — Staff Login</title>
  ...
  <form class="login-form" method="POST" action="{{ route('staff.login.submit') }}">
    ...
    <div class="form-group">
      ...
      <div class="input-icon-wrap">
        ...
        <input type="email" name="email" class="form-input" placeholder="staff@rentabike.com"
    ...
    <button type="submit" class="login-submit">Sign In to Staff Portal</button>
