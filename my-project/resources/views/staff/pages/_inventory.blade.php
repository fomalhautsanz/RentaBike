        ...
        @forelse($bikes ?? [] as $bike)
          ...
          @endif
            ...
            <div style="display:flex;align-items:center;gap:8px">
              ...
              @endif
              <button type="button" class="back-btn" title="Edit bike" aria-label="Edit {{ $bike->bike_code }}" onclick="event.preventDefault(); event.stopPropagation(); openBikeAction('edit', @json(['id' => $bike->bike_code, 'type' => $bike->type, 'condition' => $bike->condition]))">
              ...
              <button type="button" class="back-btn" title="Delete bike" aria-label="Delete {{ $bike->bike_code }}" onclick="event.preventDefault(); event.stopPropagation(); openBikeAction('delete', @json(['id' => $bike->bike_code]))">
