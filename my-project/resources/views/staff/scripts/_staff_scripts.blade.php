...
function openBikeAction(action) {
  ...
  const body = action === 'delete'
    ...
    : `<form method="POST" action="{{ route('staff.inventory.store') }}">
         ...
         <div class="form-group"><label class="form-label" for="bike-type">Bike Type</label><select id="bike-type" name="bike_type" class="form-select" required><option value="Road Bike">Road Bike</option><option value="Sidecar Bike">Sidecar Bike</option><option value="Children's Bike">Children's Bike</option></select></div>
